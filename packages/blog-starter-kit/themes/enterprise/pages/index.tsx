...
const IndexContent = ({ publication, initialAllPosts, initialPageInfo }: Props) => {
...
export default function Index({ publication, initialAllPosts, initialPageInfo }: Props) {
	return (
		<AppProvider publication={publication}>
			<IndexContent publication={publication} initialAllPosts={initialAllPosts} initialPageInfo={initialPageInfo} />
		</AppProvider>
	);
}
