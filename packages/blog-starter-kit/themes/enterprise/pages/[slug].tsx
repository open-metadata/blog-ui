		...
		<>
			...
			<div className="grid grid-cols-6 pt-10 lg:pt-0">
				<div className="col-span-full lg:col-span-4">
					...
					{(post.tags ?? []).length > 0 && (
						<div className="text-slate-600 dark:text-neutral-300 px-5 my-3 lg:hidden">
				...
				<div className="col-span-2 hidden lg:block">
					<div className="sticky top-24 mb-4 w-full px-5">
						<div className="w-full rounded-2xl border p-5 text-base leading-snug dark:border-neutral-800 dark:text-neutral-50">
							...
							/>
							<div className="mb-4 mt-2 flex w-full flex-row flex-wrap  items-center gap-2 px-2 text-slate-700 dark:text-neutral-300 md:px-0">
