...
export const PostTOC = () => {
	...
	return (
		<div className="w-full px-5">
			<div className="mx-auto w-full max-w-screen-lg rounded-2xl border p-5 text-base leading-snug dark:border-neutral-800 dark:text-neutral-50 md:p-8 md:text-lg">
